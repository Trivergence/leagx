...
class ApiService {
      ...
      if (connectivityResult != ConnectivityResult.none) {
        ...
        if (_response.statusCode == 200 || _response.statusCode == 201) {
          List<News> listOfNews =
              newsFromJson(jsonEncode(_response.data));
          return listOfNews;
        }
      } else {
        ToastMessage.show(Strings.noInternet, TOAST_TYPE.error);
  ...
  static Future<List<Leader>> getLeaders({
    required String url,
    Map<String, dynamic>? parameters,
    Map<String, dynamic>? headers,
  }) async {
    try {
      ...
      if (connectivityResult != ConnectivityResult.none) {
        ...
        print('get response: ${_response.data}');
        if (_response.statusCode == 200 || _response.statusCode == 201) {
          List<Leader> listOfLeaders = leaderFromJson(jsonEncode(_response.data));
  ...
  static Future<bool> postWoResponce({
    ...
    static Future<bool> makePrediction({
    dynamic body,
    Map<String, dynamic>? parameters,
    Map<String, dynamic>? headers,
  }) async {
    try {
      ...
      if (connectivityResult != ConnectivityResult.none) {
        ...
        print('post response: ${_response.data}');
        if (_response.statusCode == 200 || _response.statusCode == 201) {
          ToastMessage.show(_response.data["success"], TOAST_TYPE.msg);
          return true;
        }
      } else {
        ToastMessage.show(Strings.noInternet, TOAST_TYPE.error);
