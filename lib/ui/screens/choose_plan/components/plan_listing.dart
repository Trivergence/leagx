        ...
        ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              return PlanWidget(
                ...
                index: index,
                isSelected:
                    _userSummary != null && _userSummary!.currentPlan != null
                        ? listOfPlans[index].id == _userSummary!.currentPlan!.id
                        : false,
                onPlanSelected: () {
                  onItemPressed(listOfPlans[index].id,
                      listOfPlans[index].price.toStringAsFixed(0));
                },
              );
            })
        : Padding(
