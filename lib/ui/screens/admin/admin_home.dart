...
class _AdminScreenState extends State<AdminHomeScreen> {
  ...
  static List<charts.Series<OrdinalSales, String>> _createSampleData() {
    final desktopSalesData = [
       OrdinalSales('2014', 5, charts.ColorUtil.fromDartColor(Colors.blue)),
       OrdinalSales('2015', 25, charts.ColorUtil.fromDartColor(Colors.blue)),
       OrdinalSales(
          '2016', 100, charts.ColorUtil.fromDartColor(Colors.blue)),
       OrdinalSales('2017', 75, charts.ColorUtil.fromDartColor(Colors.blue)),
    ];
    ...
    final mobileSalesData = [
       OrdinalSales('2014', 10, charts.ColorUtil.fromDartColor(Colors.pink)),
       OrdinalSales('2015', 15, charts.ColorUtil.fromDartColor(Colors.pink)),
       OrdinalSales('2016', 50, charts.ColorUtil.fromDartColor(Colors.pink)),
       OrdinalSales('2017', 45, charts.ColorUtil.fromDartColor(Colors.pink)),
    ];
